...
SetPointLight( int ilight, float x, float y, float z,  float r, float g, float b )
{
	...
	glLightfv(ilight, GL_AMBIENT, MulArray3(1.f, 1.0f, 1.0f, 1.0f));   // Adjust the ambient intensity
	glLightfv(ilight, GL_DIFFUSE, MulArray3(1.0f, r, g, b));              // Adjust the diffuse intensity
	glLightfv(ilight, GL_SPECULAR, MulArray3(1.f, 1.0f, 1.0f, 1.0f));   // Keep the specular intensity
